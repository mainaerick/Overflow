...
export const ROOM_PATICIPANT_ADD = `${API_URL}/room`;
export const ROOM_MESSAGE = `${API_URL}/message/room`;
...
export function roomparticipantadd(userId:string, roomId:string) {
  return axios.post(`${API_URL}/${roomId}/users/${userId}`);
}
export function roomgetone(roomId:string|undefined) {
  ...
  export function roomgetall() {
    return axios.get(ROOM_GET_ALL);
  }
  export function roomdelete(roomId:string|undefined) {
    return axios.delete(`${ROOM_DELETE}/${roomId}`);
  }
...
export function roommessage(roomId:string|undefined,body:string) {
    return axios.put(`${ROOM_MESSAGE}/${roomId}`,{
        body
    });
  }
  export function roommessagetall(roomId:string|undefined) {
    return axios.get(`${ROOM_MESSAGE}/${roomId}`);
  }
