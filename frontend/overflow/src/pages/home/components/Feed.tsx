...
<div className="roomListRoom">
    <div className="roomListRoom__header">
        <a href="{% url 'user-profile' room.host.id %}" className="roomListRoom__author">
    ...
    <div className="roomListRoom__content">
        <a href="{% url 'room' room.id %}">{"Lets learn Java"}</a>
    </div>
    <div className="roomListRoom__meta">
        <a href="{% url 'room' room.id %}" className="roomListRoom__joined">
        ...
        <p className="roomListRoom__topic">{"Java"}</p>
    </div>
</div>
// {% endfor %}
  )
