...
public class RoomController {
    ...
    @PostMapping
    public void addRoom(@AuthenticationPrincipal User userAuth, @RequestBody RoomRequest roomRequest) {
...
//        return roomService.getRoombyId(roomId);
    ...
    public RoomResponseDTO updateRoom(@AuthenticationPrincipal User userAuth,@PathVariable long roomId,@RequestBody RoomUpdateRequest roomUpdateRequest){

        return roomService.updateRoom(userAuth,roomId,roomUpdateRequest);
    }

    @DeleteMapping("/delete/{roomId}")
    public void deleteRoom(@AuthenticationPrincipal User userAuth,@PathVariable long roomId){
